...
class App extends React.Component{
  ...
  constructor(props){
    ...
    this.state = {
      books:[
        ...
        {id:5, rating: 5, title: 'La Biblia', image: 'libro06.jpg'},
        {id:6, rating: 4, title: 'Satanas', image: 'libro07.jpg'},
        {id:7, rating: 5, title: 'Cien años de soledad', image: 'libro08.jpg'}
      ],
      copyBooks: []
    };
  ...
  render(){
    return (
      <div className="app">
        <Menu title="ARamos" onsearch={this.onSearch} onadd={this.addItem} />
